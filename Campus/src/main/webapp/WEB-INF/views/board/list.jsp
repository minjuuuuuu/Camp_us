   ...
   <div class="content-wrapper">
    ...
    <form id="filterForm" method="get" action="${pageContext.request.contextPath}/boardlist">
      ...
      <div class="top-bar">
        ...
        <div class="top-right">
          <label><input type="checkbox" name="hideMine" ${hideMine == 'on' ? 'checked' : ''}> 내 글 숨기기</label>
      ...
      <tbody>
        ...
        <c:forEach var="board" items="${boardList}" varStatus="status">
          <tr>
            ...
            <td>
              <a href="${pageContext.request.contextPath}/board/detail?bno=${board.bno}">${board.title}</a>
    ...
    <div class="pagination">
      ...
      <a href="?page=${page-1}" ${page == 1 ? 'class="disabled"' : ''}>&lt;</a>
      <c:forEach var="i" begin="1" end="${totalPage}">
        <a href="?page=${i}" class="${i == page ? 'active' : ''}">${i}</a>
      </c:forEach>
      <a href="?page=${page+1}" ${page == totalPage ? 'class="disabled"' : ''}>&gt;</a>
      <a href="?page=${totalPage}">&raquo;</a>
    </div>

<!-- 작성 버튼 영역 -->
<div class="write-btn">
  <button type="button" class="btn btn-primary" onclick="openWritePopup()" style="padding: 6px 12px; font-size: 14px; border-radius: 4px; background-color: #2ac1bc; color: white; border: none; height: 36px;">
    작성하기
  </button>
</div>
